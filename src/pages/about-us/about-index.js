...
function About() {
  ...
  useEffect(() => {
    $('.about-title').on(' mouseenter ', function () {
      $('.border-bottom-blue').css('width', '30%').css('transition', '1.5s')
    })
  }, [])
  useEffect(() => {
    $('.about-title').on('mouseleave', function () {
      $('.border-bottom-blue').css('width', '5%').css('transition', '1.5s')
    })
  }, [])
  ...
  return (
    <>
      <div className="container mt-220 ">
        <div></div>
        <div className="about-banner-group">
          <div className="about-banner-contentgroup">
            ...
            <div className="about-banner-pic ml-32 ">
        ...
        <div className="container-1">
          <div className="about-big-group ">
            <div className="about-title">
              Cooperative Advantages<div className="border-bottom-blue"></div>
            </div>
            <div className="herro-section-top-group ">
              ...
              <div className="about-titlebox about-border-ck-bottom-2 about-title-28  ">
                ...
                <p className="padding-top-3">產品研發</p>
              </div>
            ...
            <div className="about-herro-section-bottom-group">
              <div className="about-img-wrap ">
                ...
                <div className="carousel-pic pic-block3">
                  <img src={aboutherrosection3} alt="aboutaboutherrosection3" />
                </div>
