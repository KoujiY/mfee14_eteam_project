  ...
  return (
    <>
      <div className="container">
        <div className="about-banner-after"></div>
        <div className="container-1">
          <div className="about-banner-group">
            <div className="about-banner-contents">About</div>
