    ...
    <>
     <div class="container">
        <div class="nav ">
            ...
            <div class="icon-s-none ">
                <a href="#">
                 
                    <svg class="nav-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="logo"><a href="#/"><img src="./svg/LOGO.svg" alt="" /></a></div>
            <div class="navbar">
                <li>
                    <div class=" nav-three-gp">
                        <a href="#/">
                            <div class="three-gp-flex">

                                <div>
                                    <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 101.01 101">
                                        <defs>
                                            <style>
                ...
                <li>
                    ...
                    <div class=" nav-three-gp  d-play-none">
                        <a href="#/">
                            <div class="three-gp-flex ">
            ...
            <div class="loginbar">
                <div class="three-gp-flex">
                    <a href="#/">
                        <svg class="nav-icon-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 101.01 101">
                            <defs>
                                <style>
            ...
            <div class="icon-s-none ">
                <a href="#/">
                    ...
                    <svg class="nav-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="herro-section">
            ...
            <div class="herro-text">
                <div>
                    ...
                    <svg class="nav-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g>
                            <g>
                                <polygon points="447.894,263.57 275.989,435.474 275.989,0 236.011,0 236.011,435.474 64.106,263.57 35.838,291.838 256,512 
			476.162,291.838 		" />
                            </g>
                        </g>
                        <g>
            ...
            <div class="onepage-rectangle"></div>

            <div class="herro-button-left"><a href="#/">尋找咖啡</a> </div>
            <div class="herro-button-right"><a href="#/">尋找店家</a> </div>
        ...
        <div class="two-section">
            <div class="two-colorship"><img src="./img/colorshlip.png"> <div/>
            <div class=" twopage-pic">
                <img src="./img/twosection.jpg" alt="no-pic">
            <div/>
            <div class=" phone-twopage-pic">
                <img src="./img/phone-twosection.jpg" alt="no-pic">
            <div/>

            <div class="cardtwo">

                <div class='fontsize-34'>我們相遇在世界的角落</div>

                <div class="mt-30">
                    <div class='fontsize-34 px-15'>在台灣再度重逢</div>
                    <div class='fontsize-34 px-15'>在你手中</div>
                    <div class='fontsize-34 px-15'>為你研磨最好的一品</div>

                </div>

                <div class="button-blue-left"><a href="#/">尋找咖啡</a>
                </div>
                <div class="button-blue-right"><a href="#/">尋找店家
                    </a>
                </div>
            </div>
            <div class="twopage-rectangle"></div>

        <div/>
        <div class="phone-long-colorship"><img src="./img/long-colorship.png" alt="no-pic"><div/>



        <div class="three-section">
            <div class="threepage-pic"><img src="./img/threesection.jpg" alt="no-pic">
            <div/>
            <div class="phone-three-pic">
            ...
            <div class="three-content">
                <div class="fontsize60">
                    <div class="py-15">在車水馬龍的都會中，</div>
                    <div class="py-15">你渴求著片刻的喘息...</div>
                </div>
                <div class="fontsize16 py-15">我們將守著那寧靜的角落，將一抹芬芳贈與給你</div>
            </div>

            <div class=" fontsize-34 newproduct ">New product listing
                <div class="border-bottom-white">
                </div>
            </div>


            <div class="button-black fontsize-20">
                <a href="#/"> ALL</a>
                <div><img src="" alt=""> <div/>
            <div/>
            ...
            <div class="box">
                <div class="box1">
                    ...
                    <div class="item-1">
                        <div class="item-2">
                            <div class="fontsize-20">精選咖啡豆</div>
                            <div>svg</div>
                        </div>
                        <div>超好喝的超好喝的超好喝的超好喝的超好喝的超好喝的=超好喝的超好喝的超好喝的</div>
                        <div class="card-button"><a href="#/"> 購買</a>
                        </div>
        ...
        <div class="button03">
            <div><button>左</button></div>
            <div><button>右</button></div>

        </div>

        <div class="long-colorship"><img src="./img/long-colorship.png" alt="no-pic"><div/>
        ...
        <div class="container-1">
            <div class="best-selling-group">
                <div class="fontsize-34 ">Best-selling goods
                    <div class="border-bottom-blue"> </div>
                </div>


                <div class=" button-blue-bg fontsize-20">
                    <a href="#/"> ALL </a>
                    <div><img src="" alt=""> <div/>
                <div/>
            ...
            <div class="container-1">
                <div class="footer-group">
                    ...
                    <div class="footer-left">
                        <div>
                            <div class="logo2"><img src="./svg/LOGO.svg" alt="no-pic" /></div>
                        </div>
                        <ul>
                            ...
                            <div class="footer-icon">
                                <li class="nav-icon-2"><a href="#/"><svg viewBox="-110 1 511 511.99996"
                                ...
                                <li class="nav-icon-2"><a href="#/"><svg viewBox="0 0 512.00096 512.00096"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li class="nav-icon-2"><a href="#/"><svg viewBox="0 -45 512.00013 512"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li class="nav-icon-2"><a href="#/"><svg viewBox="0 -62 512.00199 512"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div class="footer-center">
                        <div class="four-information">
                            ...
                            <div class="coffee">
                                <ul>
                                    <li> <a href="#/">地球儀展示</a></li>
                                    <li> <a href="#/">台灣地圖展示</a></li>
                                    <li><a href="#/">屬性標籤分類</a></li>
                                    <li><a href="#/">產地/產品介紹</a></li>
                                </ul>
                    ...
                    <div calss='footer-right'>
                        <div class="button-w mb-30"> <a href="#/">聯絡我們</a> </div>
                        <div class="button-w mb-30"><a href="#/">加入我們
                            </a></div>
                        <div class="button-w mb-30"><a href="#/">關於我們</a></div>
                    </div>
                    ...
                    <div/>
                <div/>
                <div class='copyright'>Copyright © 2021 MERCURIUS - Coffee Server & Design.</div>
